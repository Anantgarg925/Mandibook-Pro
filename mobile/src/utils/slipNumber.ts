...
export async function getNextSlipNumber(shopId: string, offsetBase = 0, isOffline = false): Promise<number> {
  ...
  // Supabase unavailable / offline — fall back to AsyncStorage continuous value
  try {
